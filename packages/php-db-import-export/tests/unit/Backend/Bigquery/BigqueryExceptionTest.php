    ...
    public function provideJobAndExpectedError()
    {
        yield 'single error' => [
            ...
            function (string $message) {
                ...
                $this->assertCount(1, explode(PHP_EOL, $message));
            },
        ];
        yield 'multiple errors' => [
            ...
            function (string $message) {
                ...
                $this->assertCount(2, explode(PHP_EOL, $message));
            },
        ];
        yield 'too many errors' => [
            ...
            function (string $message) {
                $this->assertStringStartsWith(
                    'There were too many errors during the import. For more information check job', $message
                );
        ...
        yield 'Required column value is missing' => [
            ...
            function (string $message) {
                $this->assertEquals('Required column value is missing', $message);
                $this->assertCount(1, explode(PHP_EOL, $message));
            },
        ];
