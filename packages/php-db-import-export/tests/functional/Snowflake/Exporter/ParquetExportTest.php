...
class ParquetExportTest extends SnowflakeBaseTestCase
{
    ...
    public function testExportCompressedParquet(): void
    {
        ...
        $destination = $this->getDestinationInstance($this->getExportDir() . '/parquet_compressed_test', 'parquet');
    ...
    public function testExportParquetWithQuery(): void
    {
        ...
        $destination = $this->getDestinationInstance($this->getExportDir() . '/parquet_query_test', 'parquet');
    ...
    private function prepareStage(Storage\DestinationInterface $destination): string
    {
