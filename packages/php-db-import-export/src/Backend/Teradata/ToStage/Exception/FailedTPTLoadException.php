...
class FailedTPTLoadException extends Exception
{
    ...
    public function __construct(
        ...
        errTableContent : " . ($errTableContent ? json_encode($errTableContent, JSON_THROW_ON_ERROR) : 'no data') . "\n\n 
        errTable2Content : " . ($errTable2Content ? json_encode($errTable2Content, JSON_THROW_ON_ERROR) : 'no data') . " \n\n 
        ",
            $exitCode ?? 0
        );
        $this->stdErr = $stdErr;
