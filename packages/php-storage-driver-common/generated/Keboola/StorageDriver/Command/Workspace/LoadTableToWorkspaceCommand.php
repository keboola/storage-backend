...
/**
 **
 * Command is used to copy tables from Storage to Workspace Input mapping (IM)
 * Interface is similar to TableImportFromTableCommand in table.proto
 *
 * Generated from protobuf message <code>keboola.storageDriver.command.workspace.LoadTableToWorkspaceCommand</code>
 */
class LoadTableToWorkspaceCommand extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.keboola.storageDriver.command.workspace.LoadTableToWorkspaceCommand.SourceTableMapping source = 1;</code>
     */
     ...
     *
     *     @type \Keboola\StorageDriver\Command\Workspace\LoadTableToWorkspaceCommand\SourceTableMapping $source
    ...
    /**
     * Generated from protobuf field <code>.keboola.storageDriver.command.workspace.LoadTableToWorkspaceCommand.SourceTableMapping source = 1;</code>
     * @return \Keboola\StorageDriver\Command\Workspace\LoadTableToWorkspaceCommand\SourceTableMapping|null
     */
    ...
    /**
     * Generated from protobuf field <code>.keboola.storageDriver.command.workspace.LoadTableToWorkspaceCommand.SourceTableMapping source = 1;</code>
     * @param \Keboola\StorageDriver\Command\Workspace\LoadTableToWorkspaceCommand\SourceTableMapping $var
     * @return $this
     */
    public function setSource($var)
    {
        GPBUtil::checkMessage($var, \Keboola\StorageDriver\Command\Workspace\LoadTableToWorkspaceCommand\SourceTableMapping::class);
        $this->source = $var;
