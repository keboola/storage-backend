...
class SnowflakeDSNGeneratorTest extends TestCase
{
    ...
    public function testFailsWhenPasswordIsEmptyString(): void
    {
        $this->expectException(DriverException::class);
    ...
    public function testFailsWhenPrivateKeyPathIsEmptyString(): void
    {
        $this->expectException(DriverException::class);
        $this->expectExceptionMessage('"privateKeyPath" must be a non-empty string.');
