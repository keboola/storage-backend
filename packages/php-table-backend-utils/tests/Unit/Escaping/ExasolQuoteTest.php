...
class ExasolQuoteTest extends TestCase
{
    /**
    ...
    {
        self::assertSame($expectedOutput, ExasolQuote::quote($value));
    }
    ...
    {
        self::assertSame($expectedOutput, ExasolQuote::quoteSingleIdentifier($value));
    }
}
