...
class SnowflakeQuoteTest extends TestCase
{
    /**
    ...
    {
        self::assertSame($expectedOutput, SnowflakeQuote::quote($value));
    }
    ...
    {
        self::assertSame($expectedOutput, SnowflakeQuote::quoteSingleIdentifier($value));
    }
}
